#FROM: https://blog.paperspace.com/facial-recognition-using-deep-learning/
#Execute: python face_recog.py
...
def compare_face_encodings(known_faces, face):
    ...
    print "compare: ",np.linalg.norm(known_faces - face, axis=1)
...
for path_to_image in paths_to_images:
    ...
    #print face_encodings_in_image[0]
